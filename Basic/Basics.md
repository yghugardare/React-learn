...
- Rules -
  ...
  2. To return multiple elements from a component, **wrap them with a single parent tag.**This empty tag is called a _[Fragment.](https://react.dev/reference/react/Fragment)_ Fragments let you group things without leaving any trace in the browser HTML tree. `<> Code here </>`
...
export default function Profile() {
  return (
    <Avatar person={{ name: "yash", age: 21 }} size={100} job="developer" />
  );
}
```
